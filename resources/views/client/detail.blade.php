                                ...
                                <div class="swiper-wrapper">
                                    @foreach ($product->productVariants as $variant)
                                        @if ($variant->images->isNotEmpty())
                                            <!-- Kiểm tra xem productVariant có ảnh không -->
                                            @foreach ($variant->images as $image)
                                                <div class="swiper-slide product-single__image-item">
                                                    <img loading="lazy" class="h-auto"
                                                        src="{{ asset('storage/' . $image->image_path) }}" width="674"
                                                        height="674" alt="{{ $variant->color->name }}" />
                            ...
                            @if ($product->sale_price)
                                <span class="current-price">
                                    ...
                                    <svg style="height: 0.9em; width: 0.7em; vertical-align: middle; margin-left: -6px;"
                                        viewBox="0 0 16 16">
                                        <text x="0" y="12" font-family="Arial, sans-serif" font-size="20"
                    ...
                    <form name="addtocart-form" method="post">
                                    ...
                                    @if (!in_array($variant->color->name, $displayedColors))
                                        <div class="color-option-wrapper">
                                            ...
                                            <label for="color{{ $variant->color->id }}"
                                                class="color-box d-flex align-items-center">
                        ...
                        <div class="product-single__sizes mb-4">
                            ...
                            <div class="size-options d-flex flex-wrap gap-2" id="size-options">
                                <!-- Các size sẽ được load động ở đây -->
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="size-guide-info mt-3">
                                    <p>Measurement Tips:</p>
                                    <ul>
                                        <li>Chest: Measure under your arms, around the fullest part of your chest.</li>
                                        <li>Waist: Measure around your natural waistline, keeping the tape comfortably
                                            loose.</li>
