                    ...
                    <div id="accordion-filter-2" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                ...
                                @php
                                $isActive = request('color') == $color->id ? 'active' : '';
                                @endphp
                                <a href="{{ request()->fullUrlWithQuery(['color' => $color->id]) }}"
                                    class="swatch-color {{ $isActive }}" style="color: {{$color->hex_code}}"></a>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="accordion-filter-size" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <div class="d-flex flex-wrap">
                                ...
                                @php
                                $isActive = request('size') == $size->id ? 'active' : '';
                                @endphp
                                <a href="{{ request()->fullUrlWithQuery(['size' => $size->id]) }}"
                                    class="swatch-size btn btn-sm btn-outline-light mb-3 me-3 {{ $isActive }}">
                                    {{ $size->name }}
                                </a>
                                @endforeach
                            </div>
                    ...
                    <div id="accordion-filter-brand" class="accordion-collapse collapse show border-0"
                        ...
                        <div class="accordion-body px-0 pb-0">
                            <select class="form-select" onchange="if(this.value) window.location.href=this.value;">
                                <option value="{{ request()->fullUrlWithQuery(['brand' => null]) }}">All Brands</option>
                                @foreach ($brands as $brand)
                                    <option value="{{ request()->fullUrlWithQuery(['brand' => $brand->id]) }}"
                    ...
                    <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <a href="{{ route('product.detail', $product->id) }}">
                                            <img loading="lazy" src="{{ asset($product->image_url) }}" width="330"
                        ...
                        <div class="pc__info position-relative">
                            ...
                            <div class="product-card__price d-flex">
                                ...
                                <span class="money price text-secondary text-decoration-line-through"
